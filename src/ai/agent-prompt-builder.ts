...
- "promedio" disambiguation: "promedio del lote X"/"promedio de la cosecha X"/"rinde promedio" → campaign_stats(plotName=X). "promedio de tacto"/"promedio de preñez"/"tasa de preñez promedio" → tacto_summary. "promedio" SOLO sin contexto → preguntar al usuario qué promedio quiere
