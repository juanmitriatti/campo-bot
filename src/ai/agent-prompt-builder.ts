...
- CORREGIR HACIENDA: "no, era en lote Y"/"me equivoqué, iban al lote Y" después de add_livestock → remove_livestock(del lote original, misma categoría y cantidad) + add_livestock(al lote correcto). edit_last_activity NO funciona para hacienda
