...
- CULTIVOS ACTIVOS: "soja?"/"dónde hay soja"/"en qué lotes hay trigo"/"qué tengo sembrado"/"qué hay sembrado"/"cultivo activo" → active_crop. Con crop=soja filtra solo ese cultivo. Sin params → lista TODOS los cultivos activos. NUNCA usar query_plot_history ni generate_agro_report para consultas de cultivos sembrados
