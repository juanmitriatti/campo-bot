...
export class PendingActivityStore {
  ...
  private mirror = new PendingMirror<PendingActivity>('activity', PENDING_TIMEOUT_MS);
  ...
  /** Rellena el Map desde DB tras un restart (fill-if-missing). Llamado por
   *  los controllers al inicio de cada mensaje. */
