...
const ACTION_VERB = /\b(gaste|pague|pago|compre|compro|abone|vendi|vendo|cobre|cobro|ingrese|ingreso|facture|sembre|siembro|fumig\w*|fertilic\w*|cosech\w*|pulveric\w*|are|rastre|plante|plant\w*|regue|riegue|aplique|aplico|llovio|cayo(?:\s+\d|\s+agua|\s+lluvia)|nacio|nacieron|parieron|vacune|desparasite|cure|trate|insemine|destete|eche|pese|pesaron|pesamos|transferi|transfer\w*|pase|agrega|agregue|suma|sume|cargue|registre|registra|anote|anota|renombr\w*|cre[ae]\w*|arma\w*|borr[ae]\w*|elimin[ae]\w*|dar de alta|move\w*|mueve\w*|muevo|movi(?!miento)\w*|revert\w*|deshac\w*|reemplaz\w*|acordame|acordarme|recordame|recordarme|retire|retiramos|retiro|saque|sacamos|entregue|entregamos)\b/;
