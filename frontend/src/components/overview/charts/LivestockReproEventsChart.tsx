    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
      ...
      {!hasAnything ? (
        <div className="text-center py-12 px-4">
          <p className="text-sm text-gray-500 dark:text-gray-300 font-medium mb-1">Sin eventos reproductivos</p>
          <p className="text-xs text-gray-400 dark:text-gray-400">Registrá servicios, inseminaciones o destetes para ver la evolución.</p>
        </div>
      ) : (
