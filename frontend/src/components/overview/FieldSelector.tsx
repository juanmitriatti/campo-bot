  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="text-xs border border-gray-200 rounded-lg px-2 py-1.5 bg-white focus:outline-none focus:border-campo-500 focus:ring-1 focus:ring-campo-500 max-w-[200px]"
      >
        {fields.map(f => (
