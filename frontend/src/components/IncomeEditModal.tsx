      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-800">Editar ingreso</h3>
            <button onClick={onClose} className="text-gray-400 hover:text-gray-600 text-xl leading-none">&times;</button>
          </div>

          {income.field_name && <p className="text-sm text-gray-500 mb-1">Campo: <span className="font-medium text-gray-700">{income.field_name}</span></p>}
          {income.plot_name && <p className="text-sm text-gray-500 mb-3">Lote: <span className="font-medium text-gray-700">{income.plot_name}</span></p>}
